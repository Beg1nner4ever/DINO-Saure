...
\caption{Architecture de DINO. Une image produit 2 vues globales ($96\times96$) et 4 vues locales
...
\caption{Représentations gelées : précision $k$-NN sur STL-10 (mêmes chiffres que le
...
\caption{\textbf{Gauche} : ablations en cadre réduit. Retirer le momentum (A1) effondre la
...
\caption{Boucle d'entraînement adaptatif : le pool non étiqueté croît par tranches ; on entraîne,
