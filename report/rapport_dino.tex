...
structurent autour des objets sans supervision (quoique bruitées à notre échelle) --- et menons deux ablations exécutées inspirées de la Table~7 du
...
Nous menons deux ablations exécutées inspirées de la Table~7 du papier (plus une troisième, décrite
mais non exécutée), adaptées à notre cadre réduit (20 époques chacune). Chaque ablation ré-initialise
un modèle et ne modifie \emph{qu'un} composant. Le Tableau~\ref{tab:abl} et la Figure~\ref{fig:abl_fig}
regroupent les résultats.
...
\begin{figure}[h]
\centering
\includegraphics[width=0.56\linewidth]{../figures/fig_ablations.png}\hfill
\includegraphics[width=0.40\linewidth]{../figures/fig_multicrop_match.png}
\caption[Ablations et contribution du multi-crop]{\textbf{Gauche} : ablations en cadre réduit. Retirer le momentum (A1) effondre la
représentation \emph{sous} la borne aléatoire ; retirer le multi-crop (A2) coûte $-5{,}6$ points.
\textbf{Droite} : la contribution du multi-crop que nous mesurons ($-5{,}6$ pt) coïncide presque
avec celle du papier ($-4{,}9$ pt, Table~7), bien que l'échelle diffère d'un facteur $\sim$50.}
\label{fig:abl_fig}
\end{figure}
...
absolues, elles, ne sont pas comparables. Enfin, on observe une attention spatialement structurée
