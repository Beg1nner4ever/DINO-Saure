...
\begin{itemize}[nosep]
  \item \textbf{Précision $k$-NN top-1} ($k=20$, similarité cosinus) sur
  les features gelées du backbone enseignant : mesure la qualité \guillemotleft\ brute\,\guillemotright{} des représentations,
